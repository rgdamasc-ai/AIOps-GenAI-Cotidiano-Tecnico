...
- [diagnosticar-erros-eks](./sre/diagnosticar-erros-eks/) — Diagnostica erros de workloads em um namespace/serviço do Amazon EKS, aponta a causa raiz com evidências e sugere a correção assertiva sem aplicá-la.
